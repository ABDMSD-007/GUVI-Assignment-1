public class Main {
    ...
    public static void main(String[] args) {
        ...
        personal.displayProductInfo(); // same call, different output (Polymorphism)
        home.displayProductInfo();
        business.displayProductInfo();

        // 2. Create Customers (Encapsulation + Inheritance)
        System.out.println("Customer Registration:");

        Customer c1 = new Customer("C001", "Arjun Sharma", 32, 85000.0, 760, "Bengaluru");
        Customer c2 = new Customer("C002", "Priya Nair", 38, 120000.0, 700, "Chennai");
        Customer c3 = new Customer("C003", "Rahul Gupta", 28, 45000.0, 590, "Kolkata");

        // Person reference holds Customer - same displayInfo() call, Customer version
        // runs (Polymorphism)
        Person p1 = c1;
        Person p2 = c2;
        Person p3 = c3;
        ...
        // 3. Loan Applications (Aggregation + While loop + Switch case)

        // Application 1: Arjun - Personal Loan - should PASS
        ...
        // Application 2: Priya - Home Loan - should PASS
        System.out.println("Application 2: Priya - Home Loan");
        LoanApplication app2 = new LoanApplication("APP-002", c2, home, 3000000.0, 180);
        app2.processLoan();
        app2.displaySummary();

        // Application 3: Rahul - Business Loan - should FAIL (low credit score)
